...
/**
 * Find all LMC CLI processes (including current process)
 */
...
/**
 * Find all runaway LMC CLI processes that should be killed
 */
...
/**
 * Kill all runaway LMC CLI processes
 */
export async function killRunawayLmcProcesses(): Promise<{ killed: number, errors: Array<{ pid: number, error: string }> }> {
