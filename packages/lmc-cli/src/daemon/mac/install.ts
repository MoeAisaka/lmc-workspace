/**
 * Installation script for LMC daemon using macOS LaunchDaemons
 * 
 ...
 * 2. We assume users will run lmc frequently (every time they open their laptop)
    ...
    try {
        ...
        const plistContent = trimIdent(`
            ...
            <dict>
                ...
                <string>${configuration.lmcHomeDir}/daemon.err</string>
                
                <key>StandardOutPath</key>
                <string>${configuration.lmcHomeDir}/daemon.log</string>
        ...
        logger.info(`Check logs at ${configuration.lmcHomeDir}/daemon.log`);
