...
export interface CodexEnhancedMode {
    ...
    model?: string;
    /** LMC app instructions appended to the first Codex prompt for option chips. */
...
/**
 * LMC wraps its own injected instructions (the option-chips system prompt and
 ...
 */
export function stripLmcSystemBlocks(text: string): string {
