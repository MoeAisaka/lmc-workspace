import { agentRoot } from '@/runtime/managedRuntime';
/**
 * Cross-platform LMC CLI spawning utility
 * 
 * ## Background
 * 
...
/**
 * Spawn the LMC CLI with the given arguments in a cross-platform way.
 * 
 ...
 * 
 * @param args - Arguments to pass to the LMC CLI
 * @param options - Spawn options (same as child_process.spawn)
 * @returns ChildProcess instance
 */
export function spawnLmcCLI(args: string[], options: SpawnOptions = {}): ChildProcess {
