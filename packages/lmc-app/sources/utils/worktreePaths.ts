/** Relative path prefix where LMC creates git worktrees inside a repo. */
export const WORKTREE_DIR = '.dev/worktree';

/** Absolute path marker used to detect LMC-created worktree paths. */
export const WORKTREE_PATH_MARKER = `/${WORKTREE_DIR}/`;

/** Check if a path is inside a LMC-created worktree. */
