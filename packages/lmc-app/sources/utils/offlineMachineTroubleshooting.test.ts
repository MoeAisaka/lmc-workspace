...
describe('offline machine troubleshooting', () => {
    it('points the AI at the LMC folder and names the machine and project', () => {
        ...
        expect(guide.aiPrompt).toBe('In /Users/kirill/.happy, diagnose why LMC cannot reach "Kirill’s Mac" for project "Happy".');
    ...
    it('still produces a useful prompt before any session exists', () => {
        ...
        expect(guide.projectName).toBe('LMC');
        expect(guide.happyHomeDir).toBe('~/.lmc/agent');
    });
});