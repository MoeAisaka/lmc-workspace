...
describe('sessionFileLinks', () => {
    ...
    it('parses absolute file refs with line numbers', () => {
        const result = parseSessionFileLink('/Users/kirilldubovitskiy/projects/happy/packages/lmc-cli/src/codex/runCodex.ts:594', {
            sessionRoot,
        });

        expect(result).toEqual({
            path: '/Users/kirilldubovitskiy/projects/happy/packages/lmc-cli/src/codex/runCodex.ts',
            absolutePath: '/Users/kirilldubovitskiy/projects/happy/packages/lmc-cli/src/codex/runCodex.ts',
            relativePath: 'packages/lmc-cli/src/codex/runCodex.ts',
    ...
    it('parses relative file refs with line and column numbers', () => {
        const result = parseSessionFileLink('packages/lmc-cli/src/codex/runCodex.ts:594:2', {
            sessionRoot,
        });

        expect(result).toEqual({
            path: 'packages/lmc-cli/src/codex/runCodex.ts',
            absolutePath: '/Users/kirilldubovitskiy/projects/happy/packages/lmc-cli/src/codex/runCodex.ts',
            relativePath: 'packages/lmc-cli/src/codex/runCodex.ts',
            withinSessionRoot: true,
            line: 594,
    ...
    it('splits bare text into plain and linked segments', () => {
        const result = splitSessionFileText('Open packages/lmc-cli/src/codex/runCodex.ts:594 please.', sessionRoot);

        expect(result).toEqual([
            { text: 'Open ', link: null },
            {
                text: 'packages/lmc-cli/src/codex/runCodex.ts:594',
                link: {
                    path: 'packages/lmc-cli/src/codex/runCodex.ts',
                    absolutePath: '/Users/kirilldubovitskiy/projects/happy/packages/lmc-cli/src/codex/runCodex.ts',
                    relativePath: 'packages/lmc-cli/src/codex/runCodex.ts',
    ...
    it('resolves viewer input to an absolute path', () => {
        expect(resolveSessionFilePath('packages/lmc-app/README.md', sessionRoot)).toEqual({
            path: 'packages/lmc-app/README.md',
            absolutePath: '/Users/kirilldubovitskiy/projects/happy/packages/lmc-app/README.md',
            relativePath: 'packages/lmc-app/README.md',
            withinSessionRoot: true,
            line: null,
            column: null,
        });
