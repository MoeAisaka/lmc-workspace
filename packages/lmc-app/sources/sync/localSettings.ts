...
export const LocalSettingsSchema = z.object({
    ...
    leftSidebarCollapsed: z.boolean().describe('Collapse only the conversation list'),
    chatWideMode: z.boolean().describe('Use available conversation width on wide screens'),
    ...
    // First-run coach marks: which step the tour is on, or null once it is done.
    onboardingStep: z.enum(['device', 'session']).nullable().describe('Remaining first-run step, null once the tour is finished'),
});
