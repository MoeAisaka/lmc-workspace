...
export const lightTheme = {
    ...
    colors: {
        ...
        processSurface: '#F9F9FA',
        processGroupBorder: '#E2E2E5',
        surfaceHigh: '#F8F8F8',
        ...
        switch: {
            track: {
                // One brand blue everywhere: the iOS green made the same
                // setting look like a different control on the phone.
                active: '#0060F0',
                inactive: '#dddddd',
            },
            thumb: {
...
export const darkTheme = {
    ...
    colors: {
        ...
        processSurface: '#262626',
        processGroupBorder: '#414144',
