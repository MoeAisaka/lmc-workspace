...
const ChatListInternal = React.memo((props: {
    ...
    // Null unless this session has actually changed engines, which keeps the
    // cost of the mixed-transcript case off every other session.
    const messageEngines = React.useMemo(
        () => buildMessageEngineMap(props.messages, props.metadata?.flavor),
    ...
    return (
        <MessageEngineProvider value={messageEngines}>
        <View style={{ flex: 1 }}>
            <FlatList
