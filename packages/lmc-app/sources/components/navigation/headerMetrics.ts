...
/**
 * Desktop web shows no session title, so the header is only as tall as the
 * actions it carries — enough to sit them in the pane's top-right corner
 * rather than floating them a third of the way down the transcript.
 */
