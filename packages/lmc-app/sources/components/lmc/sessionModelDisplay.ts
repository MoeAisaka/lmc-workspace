...
import { getAvailableModels, getEffortLevelsForModel, preserveCodexEffortSelection, resolveCurrentOption } from '@/components/modelModeOptions';
...
export function resolveSessionModelDisplay(
    ...
    const effort = preserveCodexEffortSelection(flavor, selectedEffort ?? defaults.effortLevel,
        resolveCurrentOption(efforts, [selectedEffort, defaults.effortLevel]));
