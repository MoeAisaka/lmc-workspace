...
/**
 * Whether the usage row under the composer takes up space.
 *
 * The dock is anchored to the bottom, so this row's height is paid for by
 * everything above it. Compaction leaves the session without a context figure
