import { RuntimeUpdatesPanel } from '@/components/RuntimeUpdatesPanel';
    ...
    return (
        <>
            ...
            >
                ...
                <RuntimeUpdatesPanel machineId={machineId!} supported={metadata?.managedUpgrades === true} online={machineOnline}/>
                {/* CLI Availability */}
