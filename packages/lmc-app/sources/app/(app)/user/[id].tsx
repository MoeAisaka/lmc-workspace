...
export default function UserProfileScreen() {
    ...
    const [addingFriend, addFriend] = useLmcAction(async () => {
    ...
    const [removingFriend, handleRemoveFriend] = useLmcAction(async () => {
        if (!credentials || !userProfile) return;
    ...
    if (isLoading) {
        return (
            <View style={styles.loadingContainer}>
                <ActivityIndicator size="large" color="#0060F0" />
            </View>
        );
    }
        ...
        switch (userProfile.status) {
            ...
            default:
                return [{
                    ...
                    icon: <Ionicons name="person-add-outline" size={29} color="#0060F0" />,
                    onPress: addFriend,
                    loading: addingFriend,
                }];
        }
