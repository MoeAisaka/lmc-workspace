        ...
        <ScrollView style={styles.container}>
            <View style={styles.content}>
                ...
                <View style={styles.section}>
                    ...
                    <ColorSwatch name="Blue (Default Tint)" color="#0060F0" textColor="#FFF" />
                    ...
                    <ColorSwatch name="Teal" color="#0060F0" textColor="#FFF" />
                ...
                <View style={styles.section}>
                    ...
                    <ColorPair name="List Item (Selected)" bg="#0060F0" text="#FFFFFF" />
