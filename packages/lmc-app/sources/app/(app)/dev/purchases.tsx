            ...
            <ItemList>
                ...
                <ItemGroup title="Purchase Product" footer="Enter a product ID to purchase">
                    <View style={{
                        ...
                        <Item
                            ...
                            icon={isPurchasing ?
                                <ActivityIndicator size="small" color="#0060F0" /> :
                                <Ionicons name="card-outline" size={29} color="#0060F0" />
                            }
                ...
                <ItemGroup title="Actions">
                    <Item
                        ...
                        icon={<Ionicons name="refresh-outline" size={29} color="#0060F0" />}
                    ...
                    <Item
                        ...
                        icon={loadingOfferings ?
                            <ActivityIndicator size="small" color="#0060F0" /> :
                            <Ionicons name="document-text-outline" size={29} color="#0060F0" />
                        }
