    ...
    return (
        <ItemList>
            ...
            <ItemGroup title="Debug Options">
                ...
                <Item
                    title="View Logs"
                    icon={<Ionicons name="document-text-outline" size={28} color="#0060F0" />}
            ...
            <ItemGroup title="Component Demos">
                ...
                <Item
                    ...
                    icon={<Ionicons name="albums-outline" size={28} color="#0060F0" />}
            ...
            <ItemGroup title="Test Features" footer="These actions may affect app stability">
                <Item
                    ...
                    icon={<Ionicons name="key-outline" size={28} color="#0060F0" />}
            ...
            <ItemGroup title="System">
                <Item
                    ...
                    icon={<Ionicons name="card-outline" size={28} color="#0060F0" />}
                    onPress={() => router.push('/dev/purchases')}
                />
                <Item
                    title="Expo Constants"
                    subtitle="View expoConfig, manifests, and system constants"
                    icon={<Ionicons name="information-circle-outline" size={28} color="#0060F0" />}
