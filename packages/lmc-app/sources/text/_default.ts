...
/**
 * English translations for the LMC app
 * Values can be:
...
export const en = {
    ...
    agentQuestion: {
        ...
        unsupportedDescription: ({ kind }: { kind: string }) =>
            `This version of LMC cannot show a "${kind}" request. Update the app to respond.`,
    ...
    lmc: {
        ...
        orchestration: {
            ...
            field: { stage: 'Stage', goal: 'Goal', scope: 'Scope', acceptance: 'Acceptance', constraints: 'Constraints', deliver: 'Deliver', run: 'Run', summary: 'Summary', changes: 'Changes', verification: 'Verification', questions: 'Questions', blocked: 'Blocked', cost: 'Cost', model: 'Model', evidence: 'Evidence', reasons: 'Reasons' } as Record<string, string>,
            state: { dispatched: 'Dispatched', done: 'Done', blocked: 'Blocked', failed: 'Failed', accepted: 'Accepted', rejected: 'Rejected' } as Record<string, string>,
            review: 'Review',
            hubLost: 'Hub lost',
        ...
        queue: {
            ...
            steerNotNow: 'It cannot join this turn (different settings, a command, or the turn has ended). It remains queued.',
            steerAttachments: 'The attachments could not be steered and remain queued. Updated Agents support PNG, JPEG, GIF and WebP images. For other files, wait for the next turn or choose Insert.',
