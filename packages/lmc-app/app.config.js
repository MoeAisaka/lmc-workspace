...
export default {
    expo: {
        ...
        android: {
            ...
            package: bundleId,
            // Android builds need a Firebase config of your own. Upstream's is not
            // published here: it belongs to their project and would not work for you.
            // Drop your google-services.json beside this file, or set
            // LMC_GOOGLE_SERVICES_FILE, to build for Android. Web builds ignore this.
            ...(require('fs').existsSync(process.env.LMC_GOOGLE_SERVICES_FILE || './google-services.json')
                ? { googleServicesFile: process.env.LMC_GOOGLE_SERVICES_FILE || "./google-services.json" }
                : {}),
