...
- Mapping to Claude happens in `packages/lmc-cli/src/claude/utils/permissionMode.ts`:
...
`packages/lmc-app/sources/sync/storage.ts`
...
`packages/lmc-app/sources/app/(app)/new/index.tsx`
`packages/lmc-app/sources/components/NewSessionWizard.tsx`
...
`packages/lmc-app/sources/sync/sync.ts`
...
`packages/lmc-cli/src/claude/runClaude.ts`
`packages/lmc-cli/src/claude/utils/permissionMode.ts`
...
`packages/lmc-cli/src/claude/claudeLocal.ts`
