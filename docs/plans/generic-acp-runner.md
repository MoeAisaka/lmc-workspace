...
- **Session protocol types** in `lmc-wire` (`SessionEnvelope`, `createEnvelope()`).
...
**File**: `packages/lmc-cli/src/agent/acp/AcpSessionMapper.ts`
...
**Test file**: `packages/lmc-cli/src/agent/acp/AcpSessionMapper.test.ts`
...
**File**: `packages/lmc-cli/src/agent/acp/runAcp.ts`
...
**Files**:
- `packages/lmc-cli/src/index.ts` — add CLI command routing
