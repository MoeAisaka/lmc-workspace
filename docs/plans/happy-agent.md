...
- [x] Create `packages/lmc-agent/` directory with `package.json` (name: `happy-agent`, type: module, bin: `./bin/happy-agent.mjs`)
...
- [x] Add README.md to `packages/lmc-agent/` with usage examples for all commands
